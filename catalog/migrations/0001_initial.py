    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a brief description of the book', max_length=4000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shortsummary', models.TextField(default='add some text', help_text='Breif genre description', max_length=2000)),
            ],
        ),
        migrations.CreateModel(
            name='Language',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='enter the language used to write the book', max_length=100)),
            ],
        ),
        migrations.AddField(
            model_name='book',
